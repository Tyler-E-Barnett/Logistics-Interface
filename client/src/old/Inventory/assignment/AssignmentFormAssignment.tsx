...
function AssignmentFormAssignment({ id, contextType, onRefresh }) {
  const { jobId, jobStart, jobEnd, facilityId } = useContext(JobContext)!;
  ...
  const handleSubmit = async (event) => {
    ...
    const apiUrl = "/api/inventory/assignment"; // API URL
  ...
  console.log(localDateTime(jobStart), localDateTime(jobEnd));
...
export default AssignmentFormAssignment;
