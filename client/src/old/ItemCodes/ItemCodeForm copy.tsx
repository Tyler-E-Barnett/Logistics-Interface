...
//             existingItem.subItems.map(async (subItem: any) => {
//               const assemblies = await Promise.all(
//                 subItem.assemblyIds.map((id: string) => lookupAssemblyById(id))
//               );
//               return {
//                 ...subItem,
...
//                 newAssemblyId: "",
//                 assemblies, // Add assemblies to subItem
//               };
//             })
//           );
//           setItemsState((prevState) => ({
...
//   // this may not be needed.  comment it out and try to add new entry
...
const ItemCodeForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="">{JSON.stringify(itemsState)}</div>
    </form>
  );
};
