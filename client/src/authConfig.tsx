...
export const msalConfig = {
  auth: {
    clientId: "466be3d5-2c9c-458b-bea6-b51bd0bbb6bc", // This is the ONLY mandatory field that you need to supply.
    authority: "https://login.microsoftonline.com/powerstationevents.com", // Choose SUSI as your default authority.
